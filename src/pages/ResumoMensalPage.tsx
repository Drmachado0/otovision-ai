...
const Charts = lazy(() => import("./ResumoMensalCharts"));
...
export default function ResumoMensalPage() {
  ...
  return (
    <div className="space-y-6 animate-slide-in">
      ...
      {/* Charts - lazy loaded */}
      <Suspense fallback={<div className="glass-card p-5 h-64 flex items-center justify-center text-muted-foreground">Carregando gráficos...</div>}>
        <Charts meses={meses} />
      </Suspense>
